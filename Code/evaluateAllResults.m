...
%         for problem_type = {'linear_triangular'}
           for reference_point = 0:1:4
                ...
                for seed = 1:seed_number
                    ...
                    disp([WVMethod,'_',problem_type,'_',num2str(reference_point),'_',num2str(seed)]);
                end   
                file_name = strcat('./Result/evaluate_result_dim_',num2str(dimension), ...
                    '_probtype_',problem_type,'_numVec_',num2str(num_vector),'_numSol_',num2str(solution_number), ...
